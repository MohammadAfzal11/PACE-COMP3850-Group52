...
def generate_pairs(df, cbf_encoder, label_col='label'):
    ...
    for _, row in df.iterrows():
        cbf1 = cbf_encoder.encode_record(row, fields=['field1', 'field2'])
        cbf2 = cbf_encoder.encode_record(row, fields=['field3', 'field4'])
...
def main():
    ...
    train_df = pd.read_csv(r"C:\Users\afzal\Documents\GitHub\PACE-COMP3850-Group52\csv_files\target_train.csv")
    test_df = pd.read_csv(r"C:\Users\afzal\Documents\GitHub\PACE-COMP3850-Group52\csv_files\target_test.csv")
